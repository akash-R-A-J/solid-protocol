 ...
 * @returns {Uint8Array}
 */
export function poseidonHash(fields) {
    try {
 ...
 * @returns {Uint8Array}
 */
export function poseidonHashBytes(inputs) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
 ...
 * @returns {any}
 */
export function generateBJJKeypair() {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
 ...
 * @returns {boolean}
 */
export function verifySignature(pub_key_x, pub_key_y, message, r8x, r8y, s) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
 ...
 * @returns {Uint8Array}
 */
export function computeCommitment(data_fields, schema_hash, holder_pub_key_x, holder_pub_key_y, salt) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
 ...
 * @returns {Uint8Array}
 */
export function computeHardenedNullifier(master_key, revocation_nonce, verifier_address, query_context_hash, verifier_nonce, issuer_tree_root) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
 ...
 * @returns {string}
 */
export function generateIdentity(passphrase) {
    let deferred3_0;
    let deferred3_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
 ...
 * @returns {Uint8Array}
 */
export function unlockIdentity(identity_json, passphrase) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
 ...
 * @returns {Uint8Array}
 */
export function deriveKey(master_key, context) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(master_key, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {any}
 */
export function deriveCredentialKey(master_key, schema_hash) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(master_key, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {Uint8Array}
 */
export function computeIdentityState(pubkey_x, pubkey_y, revocation_nonce) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
 ...
 * @returns {boolean}
 */
export function isBjjInPrimeOrderSubgroup(pubkey_x, pubkey_y) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(pubkey_x, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('solid_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
